...
namespace F1Store.Infrastructure.Migrations
{
    ...
    [Migration("20260407064607_InitialMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("F1Store.Infrastructure.Data.Domain.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("F1Store.Infrastructure.Data.Domain.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("F1Store.Infrastructure.Data.Domain.Product", b =>
                {
                    b.HasOne("F1Store.Infrastructure.Data.Domain.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("F1Store.Infrastructure.Data.Domain.Team", "Team")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("F1Store.Infrastructure.Data.Domain.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
